...
const SignupOtp = () => {
  ...
  // const [modaVisible, setModaVisisble] = useState(false);
    ...
    <View style={styles.container}>
      <KeyboardAvoidingView
        ...
        <View style={styles.ViewButton}>
          <TouchableOpacity onPress={() => navigation.push('InputOtp')}>
            <View
              style={[
                styles.buttonbox,
                {
        ...
        <View>
          <View style={{flexDirection: 'row', marginTop: 30}}>
            ...
            <TouchableOpacity onPress={() => navigation.push('LoginOtp')}>
              <Text
          ...
          <View style={styles.ViewButtonGoogle}>
            <TouchableOpacity onPress={() => navigation.push('Signupform')}>
              <View style={styles.buttonboxPhone}>
                <Image
                  source={{
                    uri: 'https://cdn-icons-png.freepik.com/256/46/46951.png?semt=ais_hybrid',
                  }}
                  style={{width: 30, height: 30}}
                />
                <Text
...
//         if(areaData.lenght>0){
//             let defaultData = areaData.filter((a)=> a.code=="US")

//             if(defaultData.lenght>0){
